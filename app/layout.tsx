...
export default function RootLayout({
  ...
  return (
    <html lang="ko" suppressHydrationWarning>
      <body className={`${inter.className} flex min-h-screen flex-col bg-[#FAFAFA] text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50 transition-colors duration-200`}>
        {/* Next.js HTML 다크모드 강제 주입 주체 */}
